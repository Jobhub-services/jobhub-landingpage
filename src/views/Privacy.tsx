	...
	return (
		<Container>
			<div>
				<div>
					<SubContent>
						<SH1>Privacy Policy for Staak</SH1>
						<p>
							At Staak, accessible from www.staak.co, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains
							types of information that is collected and recorded by Staak and how we use it.
						</p>
						...
						<p>
							...
							they shared and/or collect in Staak. This policy is not applicable to any information collected offline or via channels other than this
						...
						<SubH2>Information we collect</SubH2>
						<p>
						...
						<SubH2>How we use your information</SubH2>
						...
						<SubH2>Log Files</SubH2>
						<p>
							Staak follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this
							...
							type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not
							linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the
							site, tracking users' movement on the website, and gathering demographic information.
						</p>
						<SubH2>Cookies and Web Beacons</SubH2>
						<p>
							Like any other website, Staak uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages
						...
						<SubH2>Google DoubleClick DART Cookie</SubH2>
						<p>
						...
						<SubH2>Our Advertising Partners</SubH2>
						<p>
							...
							partners has their own Privacy Policy for their policies on user data. For easier access, we hyperlinked to their Privacy Policies
							below.
						</p>
						<ul>
							<li>
						...
						<SubH2>Advertising Partners Privacy Policies</SubH2>
						<p>You may consult this list to find the Privacy Policy for each of the advertising partners of Staak.</p>
						<p>
							...
							advertisements and links that appear on Staak, which are sent directly to users' browser. They automatically receive your IP address
						...
						<p>Note that Staak has no access to or control over these cookies that are used by third-party advertisers.</p>
						<SubH2>Third Party Privacy Policies</SubH2>
						<p>
							Staak's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy
						...
						<SubH2>CCPA Privacy Rights (Do Not Sell My Personal Information)</SubH2>
						...
						<SubH2>GDPR Data Protection Rights</SubH2>
						...
						<p>If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us.</p>
						<SubH2>Children's Information</SubH2>
						<p>
						...
						<p>
							Staak does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child
