	...
	return (
		<Container>
			<div>
				<Header>
					<SubContent>
						<SH1>Terms and Conditions</SH1>
						<p>Last updated: February 06, 2022</p>
						<p>Please read these terms and conditions carefully before using Our Service.</p>
					</SubContent>
				</Header>
				<SubContent>
					<SubH1>Interpretation and Definitions</SubH1>
					<SubH2>Interpretation</SubH2>
					<p>
					...
					<ol>
						...
						<li>
							<p>
								<strong>Country</strong> refers to:  Bahrain
							</p>
						</li>
						<li>
							<p>
								<strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this
								Agreement) refers to AIM Innovation W.L.L , Office 24 Building 120 Road 3803 Block 338.
							</p>
						</li>
						<li>
							<p>
								<strong>Content</strong> refers to content such as text, images, or other information that can be posted, uploaded, linked to or
						...
						<li>
							...
							noreferrer
							<p>
								<strong>Feedback</strong> means feedback, innovations or suggestions sent by You regarding the attributes, performance or features of
								our Service.
							</p>
						</li>
						<li>
						...
						<li>
							<p>
								<strong>Website</strong> refers to Staak , accessible from{' '}
								<a href="http://www.staak.co" rel="external nofollow noopener noreferrer" target="_blank">
									http://www.staak.co
								</a>
							</p>
						</li>
					...
					<SubH1>Placing Orders for Goods</SubH1>
					...
					<SubH2>Order Cancellation</SubH2>
					...
					<SubH2>Your Order Cancellation Rights</SubH2>
					<p>Any Goods you purchase can only be returned in accordance with these Terms and Conditions and Our Returns Policy.</p>
					<p>
						Our Returns Policy forms a part of these Terms and Conditions. Please read our Returns Policy to learn more about your right to cancel
						Your Order.
					</p>
					<p>
						Your right to cancel an Order only applies to Goods that are returned in the same condition as You received them. You should also include
						all of the products instructions, documents and wrappings. Goods that are damaged or not in the same condition as You received them or
						which are worn simply beyond opening the original packaging will not be refunded. You should therefore take reasonable care of the
					...
					<ul>
						...
						<li>
							The supply of digital content which is not supplied on a tangible medium if the performance has begun with Your prior express consent
							and You have acknowledged Your loss of cancellation right.
						</li>
					</ul>
					<SubH2>Availability, Errors and Inaccuracies</SubH2>
					<p>
					...
					<p>
						...
						availability, and services. We reserve the right to change or update information and to correct errors, inaccuracies, or omissions at any
						time without prior notice.
					</p>
					<SubH2>Prices Policy</SubH2>
					<p>The Company reserves the right to revise its prices at any time prior to accepting an Order.</p>
					<p>
						The prices quoted may be revised by the Company subsequent to accepting an Order in the event of any occurrence affecting delivery caused
						by government action, variation in customs duties, increased shipping charges, higher foreign exchange costs and any other matter beyond
						the control of the Company. In that event, You will have the right to cancel Your Order.
					</p>
					<SubH2>Payments</SubH2>
					<p>
						All Goods purchased are subject to a one-time payment. Payment can be made through various payment methods we have available, such as
						Visa, MasterCard, Affinity Card, American Express cards or online payment methods (PayPal, for example).
					</p>
					<p>
					...
					<SubH1>Content</SubH1>
					<SubH2>Your Right to Post Content</SubH2>
					<p>
					...
					<p>
						...
						through the Service and You are responsible for protecting those rights. You agree that this license includes the right for Us to make
					...
					<SubH2>Content Restrictions</SubH2>
					<p>
					...
					<p>
						...
						and complies with this Terms, refuse or remove this Content. The Company further reserves the right to make formatting and edits and
						change the manner of any Content. The Company can also limit or revoke the use of the Service if You post such objectionable Content. As
						...
						You understand that by using the Service You may be exposed to content that You may find offensive, indecent, incorrect or objectionable,
						and You agree that under no circumstances will the Company be liable in any way for any content, including any errors or omissions in any
						content, or any loss or damage of any kind incurred as a result of your use of any content.
					</p>
					<SubH2>Content Backups</SubH2>
					...
					<SubH1>Copyright Policy</SubH1>
					<SubH2>Intellectual Property Infringement</SubH2>
					<p>
					...
					<p>
						...
						our copyright agent via email at hello@staak.co and include in Your notice a detailed description of the alleged infringement.
					</p>
					<p>
					...
					<SubH2>DMCA Notice and DMCA Procedure for Copyright Infringement Claims</SubH2>
					<p>
					...
					<p>
						You can contact our copyright agent via email at hello@staak.co. Upon receipt of a notification, the Company will take whatever action, in
						its sole discretion, it deems appropriate, including removal of the challenged content from the Service.
					</p>
					<SubH1>Intellectual Property</SubH1>
					<p>
					...
					<SubH1>Your Feedback to Us</SubH1>
					<p>
						...
						agree to grant the Company a non-exclusive, perpetual, irrevocable, royalty free, worldwide right and license to use, reproduce, disclose,
						sub-license, distribute, modify and exploit such Feedback without restriction.
					</p>
					<SubH1>Links to Other Websites</SubH1>
					...
					<SubH1>Limitation of Liability</SubH1>
					<p>
					...
					<SubH1>&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</SubH1>
					<p>
					...
					<SubH1>Disputes Resolution</SubH1>
					<p>
						If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.
					</p>
					<SubH1>For European Union (EU) Users</SubH1>
					<p>
						If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident
						in.
					</p>
					<SubH1>United States Legal Compliance</SubH1>
					<p>
					...
					<SubH1>Severability and Waiver</SubH1>
					<SubH2>Severability</SubH2>
					<p>
					...
					<SubH1>Translation Interpretation</SubH1>
					<p>
					...
					<SubH1>Changes to These Terms and Conditions</SubH1>
					<p>
					...
					<SubH1>Contact Us</SubH1>
					<p>
						If you have any questions about these Terms and Conditions, You can contact us By email
						<span style={{ color: `${colors.PURPLE_2}`, marginLeft: '10px' }}>support@staak.co</span>
					</p>
				</SubContent>
			</div>
		</Container>
